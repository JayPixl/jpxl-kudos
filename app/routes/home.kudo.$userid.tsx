import { LoaderFunction, redirect, json, LoaderArgs, ActionFunction } from "@remix-run/node"
...
export default function KudoModal() {
    ...
    return <Modal isOpen={true} className="w-2/3 p-10">
        <div className="text-xs font-semibold text-center tracking-wide text-red-600 w-full mb-2">
            {formError}
        </div>
        <form method="post">
            ...
            <div className="flex flex-col md:flex-row gap-y-2 md:gap-y-0">
                <div className="text-center flex flex-col items-center gap-y-2 pr-8">
                    ...
                    {recipient.profile.department && (
                        <span className="px-2 py-1 bg-gray-300 rounded-xl text-blue-300 m-auto">
                ...
                <div className="flex-1 flex flex-col gap-y-4">
                    ...
                    <div className="flex flex-col items-center md:flex-row md:justify-start gap-x-4">
                        <SelectBox
                            ...
                            className="w-full rounded-xl px-3 py-w text-gray-400"
